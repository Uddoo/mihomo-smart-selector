...
**NanoPi R5S LTS / ARM64、iStoreOS 24.10.8** 路由器部署中截取，对应提交
`fe393a8303aec1f01a262a1bda4b5bf316b92c36`。画面使用路由器上已有的数据，点击图片可查看原始分辨率。

截图采用明亮主题和浏览器原有的桌面视口。操作仅包括页面导航、切换界面语言，以及打开已有节点趋势；
...
[![中文实机工作台：历史扫描结果与已过期的候选比较](assets/screenshots/scan-workbench-live-20260911-zh-CN.jpg)](assets/screenshots/scan-workbench-live-20260911-zh-CN.jpg)
...
[![中文监控概览：当前选择、关注摘要和 24 小时健康排名](assets/screenshots/monitoring-overview-live-20260911-zh-CN.jpg)](assets/screenshots/monitoring-overview-live-20260911-zh-CN.jpg)
...
[![中文节点历史：观测依据、P50/P95 趋势与相关事件标记](assets/screenshots/monitoring-node-history-live-20260911-zh-CN.jpg)](assets/screenshots/monitoring-node-history-live-20260911-zh-CN.jpg)

选中的是当前节点 `JP4-HY2` 的观测序列。绿色为 P50，蓝色为 P95，灰色竖虚线标记相关事件。
...
[![中文事件时间线：Provider 关联提示与已加载事件筛选](assets/screenshots/monitoring-events-live-20260911-zh-CN.jpg)](assets/screenshots/monitoring-events-live-20260911-zh-CN.jpg)
...
[![中文监控设置：已开启的自动切换与折叠的诊断入口](assets/screenshots/monitoring-settings-live-20260911-zh-CN.jpg)](assets/screenshots/monitoring-settings-live-20260911-zh-CN.jpg)
...
[![中文节点目录：搜索、自然排序、地区推断与底部分页](assets/screenshots/node-catalog-live-20260911-zh-CN.jpg)](assets/screenshots/node-catalog-live-20260911-zh-CN.jpg)
...
[![中文选择历史：已有监控自动切换及已确认的回读结果](assets/screenshots/selection-history-live-20260911-zh-CN.jpg)](assets/screenshots/selection-history-live-20260911-zh-CN.jpg)
...
[![中文运行设置：扫描预算、可选出口验证和历史保留策略](assets/screenshots/preferences-live-20260911-zh-CN.jpg)](assets/screenshots/preferences-live-20260911-zh-CN.jpg)

图中是此部署已保存的扫描参数与可选验证控件，不代表通用默认值。连接密钥保留在服务端配置中，不出现在画面中。
截图覆盖桌面可见区域，下方还有其他设置；采集过程中没有保存配置或清理历史。
