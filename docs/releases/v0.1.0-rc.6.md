本次预发布新增扫描结果导出、复制与预览，以及测量说明和多级排序视图。
...
[扫描结果使用说明](https://github.com/Uddoo/mihomo-smart-selector/blob/v0.1.0-rc.6/docs/scan-results.md#中文) ·
[Windows 指南](https://github.com/Uddoo/mihomo-smart-selector/blob/v0.1.0-rc.6/docs/windows.md) ·
[macOS 指南](https://github.com/Uddoo/mihomo-smart-selector/blob/v0.1.0-rc.6/docs/macos.md) ·
[运行与升级说明](https://github.com/Uddoo/mihomo-smart-selector/blob/v0.1.0-rc.6/docs/operations.md) ·
[完整变更](https://github.com/Uddoo/mihomo-smart-selector/compare/v0.1.0-rc.5...v0.1.0-rc.6)

---

This prerelease adds scan result export, copy and preview, measurement details,
and multi-level sort views.
...
[Result guide](https://github.com/Uddoo/mihomo-smart-selector/blob/v0.1.0-rc.6/docs/scan-results.md#english) ·
[Full changelog](https://github.com/Uddoo/mihomo-smart-selector/blob/v0.1.0-rc.6/CHANGELOG.md)
