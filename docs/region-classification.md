...
![中文实机目录：地区推断、排序、分页与默认隐藏的内置出站及疑似提示](assets/screenshots/node-catalog-live-20260911-zh-CN.jpg)

这张通过 Microsoft Edge 从部署版本 `fe393a8` 截取的图片显示“筛选结果 299 个 · 目录共 309 项”，并明确提示已隐藏 10 个内置出站及疑似订阅提示。
