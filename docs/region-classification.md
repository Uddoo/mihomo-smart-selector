...
![中文实机目录：地区推断、排序、分页与默认隐藏的内置出站及疑似提示](assets/screenshots/node-catalog-live-20260911-zh-CN.png)

这张通过 Microsoft Edge 以 1440 × 1000 从实机截取、前端资源对应 UI 提交 `b0570dc`的图片显示“筛选结果 299 个 · 目录共 309 项”，并明确提示已隐藏 10 个内置出站及疑似订阅提示。
...
英文界面对应截图见[English node catalog](screenshots.md#node-catalog)。地区标签随界面语言翻译，节点与来源标识保留原文；名称自然排序采用对应语言的规则，行顺序可能不同。
这组截图的来源与版本边界见[截图清单](assets/screenshots/README.md#live-20260911)。
