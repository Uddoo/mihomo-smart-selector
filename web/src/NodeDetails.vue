...
import {protocolLabel, providerLabel, regionSourceLabel} from './nodeCatalog'
...
<template>
  ...
  <dl>
    <dt>推断地区</dt><dd>{{ regionLabel(node.inferred_region) }}</dd>
  ...
  <p class="region-note">地区来自配置或节点名称，尚未验证实际出口所在地。</p>
