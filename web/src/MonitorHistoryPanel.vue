...
function schedule(preserve = false) {
  ...
  if (!preserve) { timeline.value = null; markers.value = []; selectedMarker.value = null }
  error.value = ''; loading.value = true
...
<style scoped>
.history-status{min-height:22px;margin:10px 0;font-size:12px;line-height:22px;color:var(--muted)}.chart-legend{display:flex;flex-wrap:wrap;gap:8px 20px;margin-top:16px;color:var(--muted);font-size:12px}.chart-legend span{display:inline-flex;align-items:center;gap:7px}.chart-legend i{display:inline-block;width:22px;flex-shrink:0;border-top:2px solid}.chart-legend .p50-swatch{border-color:var(--green)}.chart-legend .p95-swatch{border-color:var(--info)}.chart-legend .event-swatch{border-top:2px dashed var(--muted)}
...
.event-focus{display:grid;gap:9px;background:var(--soft);padding:14px;border-radius:8px;font-size:13px;overflow-wrap:anywhere}.event-focus button{justify-self:start}.focus-marker{stroke:var(--accent);stroke-width:3;stroke-dasharray:5 3}.health-strip .focused-bucket{outline:2px solid var(--focus);outline-offset:2px}
...
.history-panel{background:var(--surface);border:1px solid var(--line);border-radius:var(--radius-md);padding:var(--monitor-panel-padding,var(--space-5));min-width:0}.history-heading{display:flex;align-items:center;justify-content:space-between;gap:15px;flex-wrap:wrap}h3{font-size:16px;margin:0 0 8px}p{font-size:13px;line-height:1.7;color:var(--muted);margin:10px 0}label{display:grid;gap:7px;font-size:13px;min-width:0;max-width:100%}select{min-width:0;max-width:100%;border:1px solid var(--line);padding:8px;color:var(--text);background:var(--surface);border-radius:6px}.metric-explanation{display:flex;flex-wrap:wrap;gap:15px;margin:18px 0;font-size:13px}summary{font-size:13px;cursor:pointer}.chart{margin-top:16px}.chart svg{width:100%;display:block;max-height:250px}.chart text{font-size:11px;fill:var(--muted)}.axis,.grid{stroke:var(--line)}.p50,.p95{fill:none;stroke-width:2}.p50{stroke:var(--green)}.p95{stroke:var(--info)}.p50-key{color:var(--green)}.p95-key{color:var(--info)}.legend{font-size:12px}.legend span{margin-right:12px}.health-strip{display:flex;gap:3px;flex-wrap:wrap;margin-top:18px}.health-strip>span{width:9px;height:22px;border-radius:2px;background:var(--muted);opacity:.65}.health-strip .success{background:var(--green);opacity:1}.health-strip .failed{background:var(--red);opacity:1}.health-strip .outside{background:transparent;border:1px solid var(--line)}.revisions{border-top:1px solid var(--line);padding-top:16px;margin-top:18px}ol{list-style:none;padding:0;max-height:280px;overflow:auto}li{display:flex;flex-wrap:wrap;gap:9px;padding:12px 0;border-bottom:1px solid var(--line);font-size:12px}li small{flex-basis:100%;overflow-wrap:anywhere}time{color:var(--muted)}.bad{color:var(--red)}@media(max-width:600px){.chart text{font-size:14px}}
</style>
