...
<style scoped>
.history-status{min-height:22px;margin:10px 0;font-size:12px;line-height:22px;color:var(--muted)}.chart-legend{display:flex;flex-wrap:wrap;gap:8px 20px;margin-top:16px;color:var(--muted);font-size:12px}.chart-legend span{display:inline-flex;align-items:center;gap:7px}.chart-legend i{display:inline-block;width:22px;flex-shrink:0;border-top:2px solid}.chart-legend .p50-swatch{border-color:var(--green)}.chart-legend .p95-swatch{border-color:var(--blue)}.chart-legend .event-swatch{border-top:2px dashed var(--muted)}
