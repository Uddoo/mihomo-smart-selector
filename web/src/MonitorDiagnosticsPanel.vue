...
const props = defineProps<{window: string; mode: 'events' | 'settings'; active: boolean; candidateCount: number}>()
...
const capacityWarning = computed(() => !!policy.value && !!retentionCapacity(props.candidateCount, policy.value)?.insufficient)
